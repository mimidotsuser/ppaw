...
import {
  MaterialRequisitionFiltersModel,
  WorksheetFiltersModel
...
export class FilterBarComponent implements OnInit, OnDestroy {
  ...
  private _filters?: MaterialRequisitionFiltersModel;
  ...
  constructor(private userService: UserService) {
    ...
    this.requestStages = [
      {id: 'issued', title: 'Complete'},
      {id: 'approved', title: 'Issue'},
